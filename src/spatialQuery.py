...
def buildVerticalEdges():
    ...
    space_intersection_pairs = findIntersectedElements(secondary_df, all_included_spaces_indices, tol_z=0.5)
    ...
    wall_intersection_paris = findIntersectedElements(secondary_df, all_intersection_related_walls_indices, tol_z=0.5)
